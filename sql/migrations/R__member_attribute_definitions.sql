...
VALUES ((SELECT id FROM member_form_section WHERE key = 'junior-basics'),
        (SELECT id FROM attribute_definition WHERE key = 'given-name'), 10),
       ((SELECT id FROM member_form_section WHERE key = 'junior-basics'),
        (SELECT id FROM attribute_definition WHERE key = 'family-name'), 20),
       ((SELECT id FROM member_form_section WHERE key = 'junior-basics'),
        (SELECT id FROM attribute_definition WHERE key = 'dob'), 30),
       ((SELECT id FROM member_form_section WHERE key = 'junior-basics'),
        (SELECT id FROM attribute_definition WHERE key = 'gender'), 40),
       ((SELECT id FROM member_form_section WHERE key = 'junior-basics'),
        (SELECT id FROM attribute_definition WHERE key = 'school'), 50),
       ((SELECT id FROM member_form_section WHERE key = 'adult-basics'),
        (SELECT id FROM attribute_definition WHERE key = 'given-name'), 10),
       ((SELECT id FROM member_form_section WHERE key = 'adult-basics'),
        (SELECT id FROM attribute_definition WHERE key = 'family-name'), 20),
       ((SELECT id FROM member_form_section WHERE key = 'adult-basics'),
        (SELECT id FROM attribute_definition WHERE key = 'gender'), 30),
...
INSERT INTO pricelist (pricelist_item_id, date_from, date_to, price, additional_unit_price)
VALUES (1, '2021-01-01', '2021-12-31', 40.00, NULL),
       (2, '2021-01-01', '2021-12-31', 70.00, 60.00),
       (3, '2021-01-01', '2021-05-31', 50.00, NULL),
       (3, '2021-06-01', '2021-12-31', 60.00, NULL),
       (4, '2021-01-01', '2021-05-31', 155.00, NULL),
       (5, '2021-01-01', '2021-05-31', 90.00, NULL),
       (5, '2021-06-01', '2021-12-31', 110.00, NULL),
       (6, '2021-01-01', '2021-05-31', 300.00, NULL),
       (7, '2021-01-01', '2021-12-31', 40.00, NULL),
       (8, '2021-01-01', '2021-12-31', 40.00, NULL),
       (9, '2021-01-01', '2021-12-31', 25.00, NULL)
ON CONFLICT DO NOTHING;

...
public class MenuBuilder {
    ...
    private final List<Menu> topMenu = List.of(
    ...
    private final List<Menu> userMenu = List.of(
            new Menu("logout", null, null, List.of(), null)
    );

    private final List<Menu> frontEndMenu = List.of(
            new Menu("home",
                    null,
                    null,
                    List.of(),
            ...
            new Menu("cricket",
                    ...
                    List.of(
                            ...
                            new Menu("result-archive",
                                    null,
                                    URI.create("javascript:;"),
                                    List.of(),
                                    List.of(
                                            new Menu("results-for-year",

...
//        i = i + 1;
    ...
    private Config.ResourceType resourceType(int index, String name, String label, String backend, String directory, String allowedExtensions, String deniedExtensions, int maxSize) {

...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Administration | ${title} -- No Page Title</title>
		...
		<link href="/assets/admin/plugins/custom/fullcalendar/fullcalendar.bundle.css?v=7.0.5" rel="stylesheet" type="text/css" />
		<!--end::Page Vendors Styles-->
		<!--begin::Global Theme Styles(used by all pages)-->
		<link href="/assets/admin/plugins/global/plugins.bundle.css?v=7.0.5" rel="stylesheet" type="text/css" />
		<link href="/assets/admin/plugins/custom/prismjs/prismjs.bundle.css?v=7.0.5" rel="stylesheet" type="text/css" />
		<link href="/assets/admin/css/style.bundle.css?v=7.0.5" rel="stylesheet" type="text/css" />
		<!--end::Global Theme Styles-->
		<!--begin::Layout Themes(used by all pages)-->
		<link href="/assets/admin/css/themes/layout/header/base/light.css?v=7.0.5" rel="stylesheet" type="text/css" />
		<link href="/assets/admin/css/themes/layout/header/menu/light.css?v=7.0.5" rel="stylesheet" type="text/css" />
		<link href="/assets/admin/css/themes/layout/brand/dark.css?v=7.0.5" rel="stylesheet" type="text/css" />
		<link href="/assets/admin/css/themes/layout/aside/dark.css?v=7.0.5" rel="stylesheet" type="text/css" />
		<!--end::Layout Themes-->
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			...
			<a href="/administration">
				<img alt="Logo" src="/assets/mcc/img/header_logo.png" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
							...
							<div class="topbar">
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
										<form>
											<!--begin::Header-->
											<div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(/assets/admin/media/misc/bg-1.jpg)">
												<!--begin::Title-->
								...
								<div class="topbar-item">
									<div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
										...
										<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">${user.givenName}</span>
											<span class="symbol-label font-size-h5 font-weight-bold"><img src="//www.gravatar.com/avatar/${user.gravatarHash}?s=35&d=identicon" /></span>
									</div>
								</div>
								<!--end::User-->
						...
						<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									...
									<span class="text-muted font-weight-bold mr-4">${subtitle}</span>
									<!--end::Actions-->
								</div>
								<!--end::Info-->
							</div>
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								<span class="text-muted font-weight-bold mr-2">&copy; ${.now?string["yyyy"]} </span>
								<a href="/" target="_blank" class="text-dark-75 text-hover-primary">${config.clubName}</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image:url(//www.gravatar.com/avatar/${user.gravatarHash}?s=100&d=identicon)"></div>
						<i class="symbol-badge bg-success"></i>
					</div>
					<div class="d-flex flex-column">
						<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">${user.givenName}
							${user.familyName}</a>
						...
						<div class="navi mt-2">
							...
							<a href="#" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5"><@spring.message code="menu.logout" /></a>
						</div>
					</div>
				</div>
				<!--end::Header-->
		...
		<ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
			<!--begin::Item-->
			<li class="nav-item mb-2" id="back_to_website" title="Check out more demos" data-placement="right">
		...
		<script src="/assets/admin/plugins/global/plugins.bundle.js?v=7.0.5"></script>
		<script src="/assets/admin/plugins/custom/prismjs/prismjs.bundle.js?v=7.0.5"></script>
		<script src="/assets/admin/js/scripts.bundle.js?v=7.0.5"></script>
		<!--end::Global Theme Bundle-->
		<!--begin::Page Vendors(used by this page)-->
		<script src="/assets/admin/plugins/custom/fullcalendar/fullcalendar.bundle.js?v=7.0.5"></script>
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="/assets/admin/js/pages/widgets.js?v=7.0.5"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>

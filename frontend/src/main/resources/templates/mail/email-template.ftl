...
<#macro callToAction link text>
    <table class="btn btn-primary p-3 fw-700" role="presentation"
        ...
        <tr>
            <td style="line-height: 24px; font-size: 16px; border-radius: 6px; font-weight: 700 !important; margin: 0;"
                ...
                <a href="${link}" class="button-link"><@spring.messageText code=text text=text /></a>
            </td>
        </tr>
        </tbody>
    </table>
...
<#macro template header>
    ...
    <head>
        ...
        <style type="text/css">
                .button-link {
                    color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: 700 !important; white-space: nowrap; background-color: #1155cc; padding: 12px; border: 1px solid #1155cc;
                }
            }
        </style>
    </head>
                    ...
                    <tr>
                        <td align="center" style="line-height: 24px; font-size: 16px; margin: 0; padding: 0 16px;">
                            ...
                            <table align="center" role="presentation" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tbody>
                                <tr>
                                    <td style="line-height: 48px; font-size: 16px; margin: 0;" align="left">
                                        ...
                                        <table class="ax-center" role="presentation" align="center" border="0"
                                            ...
                                            <tr>
                                                <td style="line-height: 48px; font-size: 16px; margin: 0;" align="left">
                                                    <img class="w-24" src="${resourcePrefix}${config.mailLogo}"
                                        ...
                                        <div class="text-muted text-center" style="color: #718096;" align="center">
                                            ...
                                            <div>
                                                &copy; ${config.clubName} ${.now?string('yyyy')}.
                                            </div>
...
<#macro row left right>
    <tr>
        <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px;" align="left" width="100%">${left}</td>
        <td class="text-right" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px;" align="right" width="100%">${right}</td>
    </tr>
</#macro>

<#macro totals left right>
    <tr>
        <td class="fw-700 border-top" style="line-height: 24px; font-size: 16px; border-top-width: 1px !important; border-top-color: #e2e8f0 !important; border-top-style: solid !important; width: 100%; font-weight: 700 !important; margin: 0; padding: 8px;" align="left" width="100%">${left}</td>
        <td class="fw-700 text-right border-top" style="line-height: 24px; font-size: 16px; border-top-width: 1px !important; border-top-color: #e2e8f0 !important; border-top-style: solid !important; width: 100%; font-weight: 700 !important; margin: 0; padding: 8px;" align="right" width="100%">${right}</td>
    </tr>
</#macro>
...
<#macro baseMembershipConfirmation season basket order translations>
    ...
    <@paragraph>
        You have registered the following members:
    </@paragraph>

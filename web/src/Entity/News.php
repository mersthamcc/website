...
class News
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=NewsAttribute::class, mappedBy="news", orphanRemoval=true)
     */
    private $newsAttributes;

    /**
     * @ORM\OneToMany(targetEntity=NewsComment::class, mappedBy="news", orphanRemoval=true)
     */
